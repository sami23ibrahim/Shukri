...
const Navbar = () => {
	...
	return (
		...
		>
				...
				>
					{isMobile ? (
						<div className="flex items-center justify-between px-4 py-2">
							<Logo logoSrc="/Assets/Logo-3.png" altText="Logo" className="w-20" />
							<button
						...
						<div className="flex items-center justify-between h-16 px-4">
							<div className="flex-shrink-0">
								<Logo logoSrc="/Assets/Logo-3.png" altText="Die Drei Zahnärzte Logo" className="w-16" />
							</div>
			...
			{menuOpen && (
				<div className="fixed inset-0 top-0 bg-black bg-opacity-98 flex flex-col items-center justify-center text-[#422f40] z-50">
					<button
