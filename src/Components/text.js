  ...
  return (
    <div className="flex flex-col lg:flex-row w-full min-h-screen py-8 gap-8 px-4 lg:px-12 items-center">
      ...
      <div className="flex-1 flex flex-col justify-center gap-8 lg:items-start lg:max-w-[50%]">
        ...
        <div
          className="text-xl md:text-3xl font-semibold font-serif text-[#515757] opacity-0 animate-fade-in-up max-w-3xl leading-relaxed text-center lg:text-left"
        ...
        <p
          className={`text-2xl md:text-4xl font-semibold font-serif text-center text-[#515757] absolute transition-opacity duration-500 ${
        ...
        <p
          className={`text-2xl md:text-4xl font-semibold font-serif text-center text-[#515757] transition-opacity duration-500 ${
            showUrsachen ? "opacity-100 animate-fade-in-up" : "opacity-0"
          }`}
          style={showUrsachen ? { animationDelay: "0s", animationFillMode: "forwards" } : {}}
        >
          Suche die <span className="border-b-2 border-[#515757] border-solid">Ursachen</span>.
        </p>
        </div>
        ...
        >
          Erhalte einen <span className="border-b-2 border-[#515757] border-solid">klaren Plan</span>.
        </p>
        </div>
      </div>
