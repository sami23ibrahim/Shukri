...
function FlipGrid() {
  ...
  if (isMobile) {
    return (
      ...
      >
        <h2
          className="text-white font-black leading-[0.85] tracking-tighter mb-6"
          style={{ fontSize: "clamp(2.5rem, 14vw, 5rem)" }}
        >
          SHUKRI<br />Title
        </h2>

        <p className="text-white text-base font-semibold leading-snug mb-8" style={{ maxWidth: "280px" }}>
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-black min-h-screen flex flex-row overflow-hidden"
