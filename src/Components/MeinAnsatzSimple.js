...
export default function MeinAnsatzSimple() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] w-full flex flex-col items-center">
        ...
        {/* Diagram — always centered */}
        <div
          className="diagram-simple-wrapper relative flex-shrink-0"
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              opacity: entered ? 1 : 0,
              animation: entered ? "popCenterSimple 0.55s cubic-bezier(0.34,1.56,0.64,1) both" : "none",
            }}
          >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  opacity: entered ? 1 : 0,
                  animation: entered
                    ? `popSimple 0.55s cubic-bezier(0.34,1.56,0.64,1) ${(i + 1) * 0.08}s both`
                    : "none",
                }}
                onMouseEnter={(e) => {
                  if (!isActive) {
              ...
              >
                ...
                <div
                  className="text-[8.5px] font-normal tracking-[0.3px] leading-[1.38]"
                  style={{ color: "#0D1A19", padding: "0 10px", whiteSpace: "pre-line" }}
                >
                  {circle.label}
                </div>
              </div>
        ...
        <div className="mt-14 w-full" style={{ maxWidth: 700 }}>
          <div
            style={{
              opacity: showPanel ? 1 : 0,
              transform: showPanel ? "translateY(0)" : "translateY(16px)",
          ...
          >
            {panelData && (
              ...
              >
                ...
                <div
                  className="text-[15.5px] font-light leading-[1.82]"
        ...
        {/* Hint */}
        <div
          className="mt-[50px] text-[11px] font-light tracking-[2.5px] uppercase"
          style={{
